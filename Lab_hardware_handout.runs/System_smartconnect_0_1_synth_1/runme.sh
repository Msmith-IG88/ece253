...
HD_PWD='C:/Users/Michael/Lab_hardware_handout/Lab_hardware_handout.runs/System_smartconnect_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log System_smartconnect_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source System_smartconnect_0_1.tcl
