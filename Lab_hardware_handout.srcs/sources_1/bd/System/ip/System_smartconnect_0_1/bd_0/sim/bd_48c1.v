...
//--------------------------------------------------------------------------------
//Command: generate_target bd_48c1.bd
//Design : bd_48c1
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_48c1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_48c1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=37,numReposBlks=29,numNonXlnxBlks=0,numHierBlks=8,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "System_smartconnect_0_1.hwdef" *) 
module bd_48c1
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  m00_exit_pipeline_imp_16HO941 m00_exit_pipeline
  ...
  m00_nodes_imp_1JSMARX m00_nodes
  ...
  s00_entry_pipeline_imp_783TPE s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_4CTYK8 s00_nodes
  ...
  s01_entry_pipeline_imp_ZXARQU s01_entry_pipeline
       (.aclk(aclk_2),
        .aresetn(aresetn_3),
  ...
  s01_nodes_imp_14PPLCE s01_nodes
  ...
  switchboards_imp_RTKAWC switchboards
...
module m00_exit_pipeline_imp_16HO941
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module s00_entry_pipeline_imp_783TPE
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_48c1_s00mmu_0 s00_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_rresp(s_axi_1_RRESP),
        .s_axi_rvalid(s_axi_1_RVALID));
  bd_48c1_s00sic_0 s00_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_48c1_s00tr_0 s00_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module s01_entry_pipeline_imp_ZXARQU
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_48c1_s01mmu_0 s01_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_48c1_s01sic_0 s01_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_48c1_s01tr_0 s01_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module switchboards_imp_RTKAWC
   (M00_SC_AR_info,
    M00_SC_AR_payld,
    M00_SC_AR_recv,
    M00_SC_AR_req,
