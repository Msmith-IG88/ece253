...
simulate()
{
  xsim System -key {Behavioral:sim_1:Functional:System} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48c1.protoinst" -protoinst "protoinst_files/System.protoinst" -log simulate.log
}
